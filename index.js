        ...
        switch (_b.label) {
            ...
            case 9:
                ...
                if (!drivers || drivers.length === 0) {
                    return [2 /*return*/, { content: [{ type: "text", text: "해당 팀의 드라이버 정보를 찾을 수 없거나 팀 ID가 올바르지 않습니다." }] }];
                }
                driverInfo = drivers.map(function (d) { return "- ".concat(d.givenName, " ").concat(d.familyName, " (\uBC88\uD638: ").concat(d.permanentNumber, ", \uAD6D\uC801: ").concat(d.nationality, ")"); }).join('\n');
            ...
            case 12:
                ...
                if (!standingsList) {
                    return [2 /*return*/, { content: [{ type: "text", text: "현재 순위 데이터가 아직 집계되지 않았습니다." }] }];
                }
                ...
                return [2 /*return*/, { content: [{ type: "text", text: "\uD604\uC7AC \uB4DC\uB77C\uC774\uBC84 \uCC54\uD53C\uC5B8\uC2ED \uC21C\uC704 (Top 10):\n".concat(standingsInfo) }] }];
            case 13: throw new Error("알 수 없는 도구입니다.");
            case 14:
                error_1 = _b.sent();
                return [2 /*return*/, {
                        content: [{ type: "text", text: "\uB370\uC774\uD130\uB97C \uBD88\uB7EC\uC624\uB294 \uC911 \uC624\uB958\uAC00 \uBC1C\uC0DD\uD588\uC2B5\uB2C8\uB2E4: ".concat(error_1) }],
                        isError: true,
                    }];
